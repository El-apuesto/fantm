        ...
        <div className="bg-fantm-dark-light/50 border border-fantm-gold/20 rounded-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-fantm-cream/60">
                <input type="checkbox" className="rounded border-fantm-gold/30 bg-fantm-dark" />
                Remember me
              </label>
              <Link to="/forgot-password" className="text-fantm-gold hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center text-sm text-fantm-cream/60">
            ...
            <Link to="/signup" className="text-fantm-gold hover:underline">
              Sign up
            </Link>
          </div>
        </div>
